    ...
    <div class="user-admin">
        <b-form>
            ...
            <b-row>
                ...
                <b-col xl=12>
                    <b-form-checkbox class="mt-2 mb-4" id='user-admin' v-model='user.admin'>Administrador</b-form-checkbox>
                </b-col>
                <b-col md='6' sm='12'>
...
export default {
    ...
    data: function() {
        return {
            ...
            fields: [
                ...
                {
                    key: 'admin', label: 'Administrador', sortable: true,  formater: value => value? 'Sim': 'Não'
                },
                {
    ...
    methods: {
        loadUsers: function() {
            axios.get(baseApiUrl + '/users').then(
                res => {
